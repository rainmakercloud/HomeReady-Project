angular.module('homeready')
    .factory('force', function($rootScope, $q, homereadyConfig, $window, $http) {
        //var appSecret;
        ...
        var loginURL = 'https://login.salesforce.com',
            ...
            appId = homereadyConfig.clientId,
         ...
         */
        function restLogin(username, password, url) {

            var deferred = $q.defer();

            var params = {
                'grant_type': 'password',
                'client_id': homereadyConfig.clientId,
                'client_secret': homereadyConfig.clientSecret,
                'username': username,
                'password': password
            };
